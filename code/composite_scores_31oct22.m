...
%motion_input = [currentdir '/../derivatives/motion_data_input.csv'];
output_path = [currentdir '/../derivatives/covariates/'];

input = '../derivatives/ISTART-ALL-Combined-042122.xlsx'; % input file  %  
