...
# TFCE Lateral Occipital Cortex
model1 <- lm(aug22_task_socialdoors_model_4_type_nppi_dmn_cnum_4_thresh_tfce_corrp_tstat13 ~
...
# Thresh zstat 4 (RS-neg) Postcentral Gyrus
